...
const BasicRadioCode = () => {
  const pre = `import { CSSProperties } from 'react'
...
const BasicRadioExample = () => {
  ...
  const post = `        <Button style={{ width: '100%' }} type="reset">
          Reset
        </Button>
